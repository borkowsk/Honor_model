...
FLOAT    USED_SELECTION=0.010;//0.10; //Jak bardzo przegrani umieraj� (0 - brak selekcji w og�le)
...
FLOAT    HONOR_AGRESSION=0.0250;//0.015;//Bazowy poziom agresji dla HONOROWYCH
FLOAT    AGRES_AGRESSION=0.0250;//POZIOM PRZYPADKOWEJ AGRESJI AGRESYWNYCH (bez calkulacji kto silniejszy!)
...
FLOAT    POLICE_EFFIC=0.00;//0.05;//0.33;0.5//0.650;//0.950; //Z jakim prawdopodobie�stwem wezwana policja obroni agenta
...
unsigned EveryStep=1;//Cz�stotliwo�� wizualizacji i zapisu do logu
